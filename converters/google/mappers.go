...
func mappers() map[string][]mapper {
	return map[string][]mapper{
		...
		"google_kms_key_ring_iam_policy": {
			{
				convert:           converter.GetKmsKeyRingIamPolicyCaiObject,
				mergeCreateUpdate: converter.MergeKmsKeyRingIamPolicy,
			},
		},
		"google_kms_key_ring_iam_binding": {
			{
				convert:           converter.GetKmsKeyRingIamBindingCaiObject,
				mergeCreateUpdate: converter.MergeKmsKeyRingIamBinding,
				mergeDelete:       converter.MergeKmsKeyRingIamBindingDelete,
				fetch:             converter.FetchKmsKeyRingIamPolicy,
			},
		},
		"google_kms_key_ring_iam_member": {
			{
				convert:           converter.GetKmsKeyRingIamMemberCaiObject,
				mergeCreateUpdate: converter.MergeKmsKeyRingIamMember,
				mergeDelete:       converter.MergeKmsKeyRingIamMemberDelete,
				fetch:             converter.FetchKmsKeyRingIamPolicy,
			},
		},
		"google_kms_crypto_key_iam_policy": {
			{
				convert:           converter.GetKmsCryptoKeyIamPolicyCaiObject,
				mergeCreateUpdate: converter.MergeKmsCryptoKeyIamPolicy,
			},
		},
		"google_kms_crypto_key_iam_binding": {
			{
				convert:           converter.GetKmsCryptoKeyIamBindingCaiObject,
				mergeCreateUpdate: converter.MergeKmsCryptoKeyIamBinding,
				mergeDelete:       converter.MergeKmsCryptoKeyIamBindingDelete,
				fetch:             converter.FetchKmsCryptoKeyIamPolicy,
			},
		},
		"google_kms_crypto_key_iam_member": {
			{
				convert:           converter.GetKmsCryptoKeyIamMemberCaiObject,
				mergeCreateUpdate: converter.MergeKmsCryptoKeyIamMember,
				mergeDelete:       converter.MergeKmsCryptoKeyIamMemberDelete,
				fetch:             converter.FetchKmsCryptoKeyIamPolicy,
			},
		},
	}
